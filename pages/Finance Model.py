...
st.subheader("1) Stock market bubbles ")
st.subheader("2) Asset Market bubbles")
st.subheader("3) Credit Bubbles ")
st.subheader("4) Commodity bubbles")
st.image("pages/stage.png")
st.image("pages/arc.png")
...
st.image("pages/gdp.png")
st.image("pages/covid.png")
st.image("pages/covid_report.png")
...
st.image("pages/cpi.png")
st.image("pages/cpi2.png")
...
st.image("pages/industri_prod.png")
st.image("pages/russia.png")
...
st.image("pages/2002.png")
st.image("pages/2008.png")
...
st.image("pages/inflation_stock.png")

st.header("The Buffett Indicator")
st.image("pages/buffet_indic.png")
st.header("An Inverted Yield Curve")

st.header("Final Framework")
st.image("pages/allbub.png")
...
st.image("pages/final1.png")

st.image("pages/tb2.png")
...
st.image("pages/tb4.png")
st.image("pages/tb5.png")
